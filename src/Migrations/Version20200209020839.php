 ...
 */
final class Version20200209020839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE usuarios (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(30) NOT NULL, apellidos VARCHAR(30) NOT NULL, nacimiento DATE NOT NULL, sexo VARCHAR(2) NOT NULL, imagen VARCHAR(255) NOT NULL, ciudad_id INTEGER DEFAULT NULL)');
