...
class __TwigTemplate_e9e99663f24e225465a51b09299e426a3a3aab296cc1aa9733dfb48d6ca4ecc3 extends Template
{
    private $source;
    private $macros = [];
  ...
  <h1>Register</h1>
    ...
    ";
        ...
        ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 14, $this->source); })()), "password", [], "any", false, false, false, 14), 'row');
        echo "
...
";
    ...
    {
        return array (  110 => 17,  104 => 14,  100 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "register/index.html.twig", "C:\\xampp\\htdocs\\Practica\\templates\\register\\index.html.twig");
    }
}
